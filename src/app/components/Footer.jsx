            ...
            <>
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/contact" className="text-orange-100 hover:text-white transition">Contact Us</Link></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/terms" className="text-orange-100 hover:text-white transition">Terms and Conditions</Link></li>
