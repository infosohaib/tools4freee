    ...
    <div className="bg-white text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto hidden sm:block">
            Tools4Freee makes it possible to generate useful data with different tools. There are a total of 28 generators in different categories.
          </p>
        </div>
